        ...
        <form action="information-user">
            ...
            <c:choose>
                <c:when test="${not empty user}">
                    ...
                    <p name="name" class="infor"><b>${user.name}</b></p><br><br>

                    <label for="address">Địa chỉ:</label>
                    <p name="address" class="infor"><b>${user.address}</b></p><br><br>

                    <label for="phone">Số điện thoại:</label>
                    <p name="phone" class="infor"><b>${user.phone}</b></p><br><br>

                    <label for="email">Email:</label>
                    <p name="email" class="infor"><b>${user.email}</b></p><br><br>
                </c:when>
                <c:otherwise>
